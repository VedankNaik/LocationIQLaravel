                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <table class="w-full">
                        ...
                        @foreach ($addresses as $address)
                            ...
                            <td class="border border-4 border-blue-800 text-center">{{$address->PlaceID}}</td>
                            <td class="border border-4 border-blue-800 text-center">{{ROUND(($address->Latitide),4)}}</td>
                            <td class="border border-4 border-blue-800 text-center">{{ROUND(($address->Longitude),4)}}</td>
                            <td class="border border-4 border-blue-800 text-center">{{$address->DisplayName}}</td>
                            <td class="border border-4 border-blue-800 text-center">{{$address->Class}}</td>
                            <td class="border border-4 border-blue-800 text-center">{{$address->Type}}</td>
                            <td class="border border-4 border-blue-800 text-center">{{ROUND(($address->Importance),2)}}</td>
                            </tr> 
                        @endforeach                                  
                        </tbody>
                    </table>
                    ...
                    <div class="p-6 bg-white border-b border-gray-200">
                        <a href="{{ url('/forwardgeocode') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Back</a>
                    </div>
                    <div class="p-6 bg-white border-b border-gray-200">
                       </div>
                    </form>
